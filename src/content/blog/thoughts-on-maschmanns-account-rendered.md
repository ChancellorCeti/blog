...
title: "My Thoughts on Melita Maschmann’s 'Account Rendered: A Dossier On My Former Self'"
pubDate: 2026-01-11
description: "I review the book, talk about some of the most interesting ideas, and discuss its relevance today."
...
<head>
  ...
  <title>My Thoughts on Melita Maschmann's "Account Rendered: A Dossier On My Former Self"</title>
  <style>
    html {
      color: #cdd6f4;
   ...
   @media (max-width: 600px) {
    ...
    <body>
        <div id="sub_body">
            <h1
id="my-thoughts-on-melita-maschmanns-account-rendered-a-dossier-on-my-former-self">My
