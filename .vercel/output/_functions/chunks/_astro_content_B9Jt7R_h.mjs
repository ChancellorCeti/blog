...
import { d as renderTemplate, m as generateCspDigest, n as spreadAttributes, w as createComponent, x as unescapeHTML } from "./server_DNCMc9Z3.mjs";
...
var ImmutableDataStore = class ImmutableDataStore {
	...
	*/
	static async fromModule() {
		try {
			const data = await import("./_astro_data-layer-content_CDFsuF8R.mjs");
